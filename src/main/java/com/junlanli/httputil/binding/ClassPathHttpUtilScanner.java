...
import com.junlanli.httputil.factory.HttpUtilFactoryBean;
...
public class ClassPathHttpUtilScanner extends ClassPathBeanDefinitionScanner {
    ...
    private void processBeanDefinitions(Set<BeanDefinitionHolder> beanDefinitions) {
        Iterator<BeanDefinitionHolder> it = beanDefinitions.iterator();
        while (it.hasNext()) {
            BeanDefinitionHolder holder = it.next();
